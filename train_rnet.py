...
from util.models import LossFn, RNet

root = 'C:/Users/hp/Documents/Thesis/MTCNN/'
annotation_file = root + 'dataset/annotation/rnet_image_annotation.txt'
...
def train_rnet(imdb):
    ...
    torch.save(net.state_dict(), os.path.join(model_store_path, "rnet_model.pt"))
    torch.save(net, os.path.join(model_store_path, "rnet_model.pkl"))
