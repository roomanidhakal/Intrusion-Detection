...
from util.models import LossFn, ONet

root = 'C:/Users/hp/Documents/Thesis/MTCNN/'
annotation_file = root + 'dataset/annotation/onet_image_annotation.txt'
...
def train_onet(imdb):
    ...
    torch.save(net.state_dict(), os.path.join(model_store_path, "onet_model.pt"))
    torch.save(net, os.path.join(model_store_path, "onet_model.pkl"))
